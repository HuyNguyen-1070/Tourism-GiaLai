...
|------|-----------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------|
| 1    | **Authentication**          | Provides APIs for:<br/>- User registration (với validation tên đăng nhập, mật khẩu, email).<br/>- Login bằng username + password.<br/>- Refresh JWT token.<br/>- Forgot password qua OTP email.<br/>- Verify OTP & đặt lại mật khẩu. | Done     |
