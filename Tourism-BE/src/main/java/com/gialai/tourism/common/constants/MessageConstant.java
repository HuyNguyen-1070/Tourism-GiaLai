...
public class MessageConstant {
    ...
    public static final String INVALID_PASSWORD = "Password must be 8–50 chars with uppercase, lowercase, numbers and special characters.";    public static final String INVALID_PHONE = "Phone number must contain only digits and be 4–20 characters long.";
