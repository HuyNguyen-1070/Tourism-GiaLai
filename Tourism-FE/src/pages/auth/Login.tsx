        ...
        <section className="lg:col-span-5 flex flex-col justify-center items-center px-margin-mobile md:px-margin-desktop py-12 bg-mist-beige relative overflow-hidden">
          ...
          <div className="w-full max-w-[440px] space-y-8 z-10">
            ...
            <div className="w-full">
              {/* CSS Overlay approach: styled visual button + transparent real Google button on top */}
              <div className="relative w-full h-[52px]">
                {/* Visual layer (decorative only) */}
                <div className="absolute inset-0 flex items-center justify-center gap-3 px-4 border border-outline/20 rounded-lg bg-white shadow-sm pointer-events-none">
                  {isGoogleLoading ? (
                    <span className="material-symbols-outlined text-[20px] animate-spin text-forest-leaf">
                      progress_activity
                    </span>
                  ) : (
                    <svg
                ...
                {/* Real Google button - transparent overlay, captures actual click */}
                <div
                  className="absolute inset-0 z-10 overflow-hidden opacity-0"
                  style={{ pointerEvents: 'auto' }}
                >
                  <div className="w-full h-full transform scale-[1.5] origin-center flex items-center justify-center">
                    <GoogleLogin
